...
export default function AssociationForm() {
  ...
  useEffect(() => {
    if (sent || errorMessage) feedbackRef.current?.focus();
  }, [sent, errorMessage]);
  ...
  if (sent) {
    return (
      <section
        id="solicitar-associacao"
        className="py-32 lg:py-40 scroll-mt-24"
        role="status"
      >
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <h2 ref={feedbackRef} tabIndex={-1} className="text-3xl font-bold text-foreground font-display">
            Solicitação enviada!
          </h2>
          <p className="mt-4 text-muted-foreground text-lg">
            Recebemos sua solicitação de associação. Nossa equipe fará o retorno
  ...
  return (
    <div id="solicitar-associacao" className="scroll-mt-24">
      <section className="py-16 bg-secondary/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">Como se associar</h2>
          <p className="text-muted-foreground mb-8">
            Podem se associar empresas de turismo constituídas como sociedades,
            simples ou empresárias, públicas ou privadas, desde que exerçam
            atividades relacionadas ao setor turístico. Reúna os documentos
            abaixo e envie sua solicitação.
          </p>
          ...
          <div className="space-y-3">
            {docs.map((doc, i) => (
              <div
                key={i}
                className="flex items-start gap-3 p-4 bg-white rounded-xl border border-border/50"
              >
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {errorMessage && (
              <p ref={feedbackRef} tabIndex={-1} role="alert" className="mb-6 text-destructive">
                {errorMessage}
              </p>
            )}
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="file-upload">Documentos</Label>
